...
from main.models import Produit, Mark, Category, Client, Represent, Order, Orderitem, Connectedusers, Cart, Promotion
...
def createcategory(request):
    name=request.POST.get('categoryname').lower()
...
def updatecategory(request):
    ...
    #category.excludedrep.set(reps)
    category.name=request.POST.get('updatecategoryname').lower()
...
def createmarque(request):
    name=request.POST.get('marquename').lower()
    # get image file
...
def updatemarque(request):
    ...
    mark.name=request.POST.get('name').lower()
...
def addoneproduct(request):
    ...
    try:
        ...
        equivalent=request.POST.get('equivalent').strip().lower()
...
def createpromotion(request):
    name=request.POST.get('promotionname').lower()
    # get image file
...
def addmark(request):
    name=request.POST.get('marque').lower()
